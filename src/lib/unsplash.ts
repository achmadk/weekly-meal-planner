...
export const searchPhotos = async <Result extends SearchPhotoResponse = SearchPhotoResponse>(query: string): Promise<Result | null> => {
...
export const trackDownload = async (downloadLocation: string) => {
    ...
    if (result.type === "error") {
        ...
        console.log("success track download: ", result);
        return result;
    }
